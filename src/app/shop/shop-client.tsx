...
export default function ShopClient({ initialProducts, initialCategories, initialTotal, initialCategory }: {
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Browse varsity jackets, bomber jackets, leather styles, puffers,
              patches, embroidery options, and team-ready apparel.
            </p>
          </div>
        </div>
      </section>
